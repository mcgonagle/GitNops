# GitNops - A Flox enabled networking toolkit
...
Network Automation Nerds, GitNops Zero to Hero [link](https://packetpushers.net/podcasts/network-automation-nerds/nan084-from-gitnops-zero-to-hero/). 
...
GitNops trainings have been provided in the past and you can schedule them [here](https://calendly.com/mcgonagle).
